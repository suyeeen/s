...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-bold text-white tracking-tight">Penilaian Guru</h1>
            <p class="text-gray-400 mt-2">Nilai rekan guru berdasarkan indikator kompetensi.</p>
        </div>

        {{-- Pilih Guru yang Dinilai --}}
        <div class="w-full md:w-80">
            <select id="pilihGuru"
                    class="w-full px-4 py-3 rounded-2xl text-white text-sm outline-none transition-all"
    ...
    <div id="infoTidakAdaGuru"
         class="rounded-3xl p-6 flex items-start gap-5"
                                ...
                                <div class="rounded-3xl p-6 transition-all duration-300"
                                    ...
                                    <div class="grid grid-cols-5 gap-3">
                                        @foreach([1 => 'Sangat Kurang', 2 => 'Kurang', 3 => 'Cukup', 4 => 'Baik', 5 => 'Sangat Baik'] as $val => $label)
                                            <label class="jawaban-option flex flex-col items-center justify-center p-4 rounded-2xl cursor-pointer transition-all text-center"
                                                   style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.06); color: #9ca3af;"
